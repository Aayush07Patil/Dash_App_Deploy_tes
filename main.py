...
def main(palettes, cargo):
    ...
    placed_products, unplaced_products, blocked_for_ULD, placed_ulds = fun.process(
...
if __name__ == "__main__":
    ...
    #fun.visualize_specific_containers_with_plotly_test(containers, placed_products, blocked_for_ULD, placed_ulds)
    print(placed_products)
